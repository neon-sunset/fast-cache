...
namespace FastCache.Benchmarks
{
    ...
    public class Comparison
    {
        ...
        private const string ItemKey = "1337";
        private const EnumKey ItemKeyEnum = EnumKey.Custom;
        ...
        {
            if (Cached<string>.TryGet(ItemKeyEnum, out var cached))
            {
                return cached.Value;
            }
        ...
        {
            ItemValue.Cache(ItemKeyEnum, TimeSpan.FromMinutes(60));
        }
