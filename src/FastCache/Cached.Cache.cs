...
public static partial class Cached
{
    ...
    public static T Cache<T, T1, T2, T3, T4, T5, T6, T7>(
        ...
        where T : notnull =>
            CacheInternal(value, HashCode.Combine(value1, value2, value3, value4, value5, value6, value7));
    ...
    public static T Cache<T, T1, T2, T3, T4, T5, T6, T7, T8>(
        ...
        where T : notnull =>
            CacheInternal(value, HashCode.Combine(value1, value2, value3, value4, value5, value6, value7, value8));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static T CacheInternal<T>(T value, int identifier) where T : notnull
    {
