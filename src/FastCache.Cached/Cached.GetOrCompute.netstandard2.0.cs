...
//    public static async Task<V> GetOrCompute<K, V>(K param1, Func<K, Task<V>> func, TimeSpan expiration) where K : notnull
//    {
//        return Cached<V>.TryGet(param1, out var cached) ? cached.Value : cached.Save(await func(param1), expiration);
//    }

//    public static async Task<V> GetOrCompute<K, V>(K param1, Func<K, Task<V>> func, TimeSpan expiration, uint limit) where K : notnull
//    {
...
//    public static async Task<V> GetOrCompute<K1, K2, V>(K1 param1, K2 param2, Func<K1, K2, Task<V>> func, TimeSpan expiration)
//    {
//        return Cached<V>.TryGet(param1, param2, out var cached) ? cached.Value : cached.Save(await func(param1, param2), expiration);
//    }

//    public static async Task<V> GetOrCompute<K1, K2, V>(K1 param1, K2 param2, Func<K1, K2, Task<V>> func, TimeSpan expiration, uint limit)
//    {
...
//    public static async Task<V> GetOrCompute<K1, K2, K3, V>(
...
//    public static async Task<V> GetOrCompute<K1, K2, K3, K4, V>(
...
//    public static async Task<V> GetOrCompute<K1, K2, K3, K4, K5, V>(
...
//    public static async Task<V> GetOrCompute<K1, K2, K3, K4, K5, K6, V>(
...
//    public static async Task<V> GetOrCompute<K1, K2, K3, K4, K5, K6, K7, V>(
